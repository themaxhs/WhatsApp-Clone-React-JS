 ...
 function Chat() {
    ...
    <div className="chat__headerRight">
        ...
        <div className="chat__body">
            ...
            <InsertEmoticonIcon />
            <form>
                <input value={input} onChange={(e) => setInput(e.target.value)} placeholder="Type message con nudes" type="text"/>
                <button onClick={sendMessage} type="submit">Send nudes</button>
            </form>
            <MicIcon />
        </div>  
</div>
